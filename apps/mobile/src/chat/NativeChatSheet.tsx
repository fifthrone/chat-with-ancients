            ...
            <SafeAreaView style={{ flex: 1 }}>
              {!expanded ? (
                <View className="px-5 pt-4 pb-5">
                  ...
                  <Text className="mt-1 font-body text-sm text-textSecondary">
                    {ancient.eraLabel}
                  </Text>
                  <Text
                    className="mt-2 font-body text-sm leading-5 text-textSecondary"
                    numberOfLines={3}
                  >
                    {ancient.shortBio}
                  </Text>
                  ...
                  >
                    <View className="flex-1 items-center">
                      ...
                      <View className="mt-2 items-center justify-center">
                        <Text className="font-display text-xl text-zinc-900">
                          {ancient.name}
                        </Text>
                        <Text className="font-body text-xs text-zinc-600">
                          {ancient.eraLabel}
                        </Text>
                        <Text
                    ...
                    <Pressable
                      ...
                      style={{
                        opacity: hydration.status === "ready" ? 1 : 0.45,
                      }}
                      onPress={() => {
                        void startNewChat();
                      }}
                    >
                      <Text className="font-body text-xl font-medium leading-none text-zinc-800">
                        +
                      </Text>
                    </Pressable>
                    <Pressable
                      ...
                      onPress={handleClose}
                    >
                      <Text className="font-body text-sm text-zinc-600">
                        Close
                      </Text>
                    </Pressable>
                  </View>
